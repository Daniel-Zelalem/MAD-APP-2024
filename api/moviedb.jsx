...
import { apiKey } from "../src/constants/index";
...
const notificationEndpoint = `${apiBaseUrl}/movie/changes?api_key=${apiKey}`;
...
// functions to get movie poaster of different widths
...
export const fallbackUserPoster =
...
export const fetchNotifications = () => {
  return apiCall(notificationEndpoint);
};

// movie detials screen apis
